...
<html>
  <head>
	...
	<script type="text/javascript">
			...
			$(function() {
				 $dg = $("#dg");
				 $grid=$dg.datagrid({
					url : "item/itemAction!findItemList.action",
					width : 'auto',
				...
				if(row){
					...
					parent.$.messager.confirm("提示","确定要删除记录吗?",function(r){  
					    if (r){  
							...
							$.ajax({
								url:"item/itemAction!delItem.action",
			...
			function updRowsOpenDlg() {
				...
				if (row) {
					parent.$.modalDialog({
						...
						width : 900,
						height :550,
						href : "jsp/itemManager/itemEditDlg.jsp?tempId="+row.itemId,
						onLoad:function(){
			...
			function addRowsOpenDlg() {
				parent.$.modalDialog({
					...
					width : 900,
					height :550,
					href : "jsp/itemManager/itemEditDlg.jsp",
					buttons : [ {
						text : '保存',
						iconCls : 'icon-ok',
						handler : function() {
  ...
  <body>
      <div data-options="region:'center',border : false">
		...
		<div id="mm">
				<div name="name">货品名称</div>
				<div name="myid">货品编码</div>
		</div>
		<table id="dg" title="货品管理"></table>
  	</div>	
  </body>
</html>
