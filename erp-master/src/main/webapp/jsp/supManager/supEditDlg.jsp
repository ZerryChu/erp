...
<script type="text/javascript">
	...
	$(function() {
		...
		var typedata=[{"type":"M","typeName":"男"},{"type":"F","typeName":"女"}];
		 $dg = $("#dg");
		 $grid=$dg.datagrid({
			url : "sup/supAction!findSuplierContactList.action?suplierId="+$("#tempId").val(),
			width : 'auto',
		...
		$("#form").form({
			url :"sup/supAction!persistenceSuplier.action",
			onSubmit : function() {
			...
			<div id="tt">
				<div title="基本资料" data-options="iconCls:'icon-cstbase'" style="padding:10px">
						<fieldset>
							...
							<input name="suplierId" id="suplierId"  type="hidden"/>
							...
							<input name="deleted" id="deleted"  type="hidden"/>
							 <table class="table">
								 <tr>
								    <th>供应商名称</th>
									<td><input name="name" id="name" placeholder="请输入供应商名称" class="easyui-textbox easyui-validatebox" type="text" data-options="required:true"/></td>
									<th>供应商编码</th>
								 ...
								 <tr>
								    ...
								    <th>采购代表</th>
									<td><input name="buyerId" id="buyerId" type="text" class="easyui-textbox easyui-validatebox" /><input name="buyerName" id="buyerName" type="hidden"/></td>
								    <th>公司法人</th>
						 ...
						 <table class="table">
							   <tr>
								 ...
								 <tr>
									...
									<th>交易状态</th>
									<td><select id="suplierStatus" class="easyui-combobox" name="suplierStatus" style="width:171px;">
...
<%--									<td><input id="setupAccount" name="setupAccount" type="text" class="easyui-textbox easyui-validatebox"/></td>--%>
				...
				<div title="供应商联系人" data-options="iconCls:'icon-help'">
							<table id="dg"></table>
							<div id="tb" style="padding:2px 0">
								<table cellpadding="0" cellspacing="0">
									<tr>
										<td style="padding-left:2px">
											<shiro:hasPermission name="supConEdit">
