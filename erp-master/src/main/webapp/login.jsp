...
<link rel="shortcut icon" type="image/x-icon"
	href="../extend/iconkey.ico" media="screen" />
...
<body>
	...
	<div id="login">
		<div class="ribbon"
			style="background-image: url(extend/typelogin.png);"></div>
		<div class="inner">
			<div class="logo">
				<img src="extend/logo.jpg" width="50%;" height="100%" alt="Please wait" />
			</div>
			<div class="formLogin">
				<form name="formLogin" action="systemAction!load.action"
					...
					<div class="tip">
						<input class="userName" name="userName" type="text" id="userName"
							title="用户名" iscookie="true" value="admin" nullmsg="请输入用户名!" />
					</div>
					<div class="tip">
					...
					<div id="cap" class="tip">
						<input class="captcha" name="captcha" type="text" id="captcha"
							...
							align="absmiddle" id="Kaptcha" src="Kaptcha.jpg" />
					</div>
					<div class="loginButton">
						<div style="padding: 3px 0; margin-right: -12px;">
							<div>
								<ul class="uibutton-group">
									<li><a class="uibutton normal" href="javascript:void(0);"
										id="but_login">登陆</a></li>
									<li><a class="uibutton normal" href="javascript:void(0);"
										id="forgetpass">重置</a></li>
								</ul>
							</div>
						</div>
						<div class="clear"></div>
	...
	<div id="versionBar">
		<div class="copyright">
			&copy; 课程设计 copyright&nbsp;2016 <span class="tip">
				(推荐使用IE9+,谷歌浏览器可以获得更快,更安全的页面响应速度)技术支持:<a href="javascript:void(0);"></a>
			</span>
		</div>
	</div>
</body>
