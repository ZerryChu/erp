...
import com.palmelf.erp.model.RolePermission;
...
public class PermissionAssignmentServiceImpl extends BaseServiceImpl implements
	...
	public List<Permission> getRolePermission(Integer roleId) {
		String sql = "SELECT t.PERMISSION_ID FROM ROLE_PERMISSION t WHERE t.STATUS = 'A' and t.ROLE_ID="
				+ roleId;
	 ...
	 * 
	 * @see
	 * com.palmelf.erp.service.PermissionAssignmentService#persistenceRole(com.palmelf.erp.model
	 * .Role)
	 */
