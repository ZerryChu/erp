...
public class PermissionAssignmentAction extends BaseAction implements
		ModelDriven<Role> {
	...
	public String findAllRoleList() throws Exception {
		...
		gridModel.setRows(permissionAssignmentService.findAllRoleList(map,
				page, rows, true));
	...
	public String getRolePermission() throws Exception {
		OutputJson(permissionAssignmentService.getRolePermission(getModel()
				.getRoleId()));
		return null;
	}
	...
	public String persistenceRoleDlg() throws Exception {
		OutputJson(
				getMessage(permissionAssignmentService
						.persistenceRole(getModel())),
