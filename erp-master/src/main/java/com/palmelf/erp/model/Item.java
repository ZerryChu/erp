...
public class Item implements java.io.Serializable {
	...
	/** full constructor */
	public Item(String myid, String name, String className, String spec, Integer amount, String unit,
			String packageUnit, Integer converts, String oldMyid, Integer taxNo, String isBatch, String isValid,
			Double cost, Double retailPrice, Double salePrice, Integer brandId, String brandName, Integer cityId,
			String cityName, String qualityPeriod, String description, Date created, Date lastmod, String status,
			Integer creater, Integer modifyer, Integer attachmentId, String barcode, String image) {
		this.myid = myid;
		this.name = name;
