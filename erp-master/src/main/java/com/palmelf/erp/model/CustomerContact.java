...
public class CustomerContact implements java.io.Serializable {
	...
	/** minimal constructor */
	public CustomerContact(Integer customerId, String name) {
		this.customerId = customerId;
		this.name = name;
	}

	/** full constructor */
	public CustomerContact(Integer customerId, String name, String className, String sexName, String organization,
			String duty, String tel, String email, String mobile, String description, String status, Date created,
